# This script combine the data from codon_occupancy_generator script outputs and generate the A-site occupancy plot

## Load package
library(tidyverse)

## Datasets
df_1 <- read.table("C:/Users/hassa/OneDrive/Desktop/occupancy/RPF_WT_Rep1_Codon_occupancy.txt",
                   header = F,
                   sep = "\t")

df_2 <- read.table("C:/Users/hassa/OneDrive/Desktop/occupancy/RPF_WT_Rep2_Codon_occupancy.txt",
                   header = F,
                   sep = "\t")

df_3 <- read.table("C:/Users/hassa/OneDrive/Desktop/occupancy/RPF_KO_Rep1_Codon_occupancy.txt",
                   header = F,
                   sep = "\t")

df_4 <- read.table("C:/Users/hassa/OneDrive/Desktop/occupancy/RPF_KO_Rep2_Codon_occupancy.txt",
                   header = F,
                   sep = "\t")
