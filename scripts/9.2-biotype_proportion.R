# this script takes RNA sequencing data, specifically counts of mapped reads for different biotypes, and creates a visual representation of how the proportions of these biotypes vary across different experimental conditions. The resulting bar plot is saved as a PDF file.
...
data <- read.table(file = "C:/Users/hassa/OneDrive/Desktop/7-featurecount/biotype_counts_processed.txt", sep = "\t", header = TRUE)
