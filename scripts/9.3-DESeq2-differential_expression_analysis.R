# This script follows the vignette: https://www.bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html
# Using DESeq2 package to identify differentially expressed genes between different experimental conditions.
...
register(SnowParam(8)) # Change this based on your computer core count
...
featurecount_data <- read.table("C:/Users/hassa/OneDrive/Desktop/7-featurecount/CDS_counts_processed.txt", header = TRUE, row.names = 1)
